...
with app.app_context():
    ...
    shack = Restaurant(name="Karen's Pizza Shack", address='079 Barr Highway')
    bistro = Restaurant(name="Sanjay's Pizza", address='25 West End')
    palace = Restaurant(name="Kiki's Pizza", address='42 North Avenue')
